  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <form
        ...
        className="form-card text-slate-950 grid grid-cols-1 lg:grid-cols-3 gap-8"
      >
        <div className="lg:col-span-2 space-y-4 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Datos de contacto</h2>
          <div>
            <label className="form-label text-slate-900">Nombre completo</label>
            <input
              value={customer.name}
              onChange={(e) => setCustomer((c) => ({ ...c, name: e.target.value }))}
              className="input-form text-slate-950 placeholder:text-gray-700 border-gray-500"
              required
            />
          ...
          <div>
            <label className="form-label text-slate-900">Teléfono</label>
            <input
              type="tel"
          ...
          <div>
            <label className="form-label text-slate-900">Dirección de entrega</label>
            <textarea
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
            ...
            <div className="border-t border-gray-300 pt-4 flex justify-between font-semibold text-lg mb-4">
